...
export default function NewProjectPage() {
  ...
  const { addProject } = useProjectMonitorStore();
    ...
    <div className="space-y-6 pb-12 max-w-2xl mx-auto select-none">
      ...
      <div>
        <h1 className="text-2xl font-extrabold tracking-tight text-foreground flex items-center gap-2">
          <FolderHeart className="h-6 w-6 text-primary" /> Create QA Project
        </h1>
        <p className="text-xs text-muted-foreground mt-0.5">Register a new project workload, status parameters, and deadline target.</p>
      </div>
